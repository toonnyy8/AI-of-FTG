...
tf.setBackend("webgl")
    ...
    .then(({ next, render, getP1, getP2, getRestart }) => {
        let count = 0
        let { clone, write, clear } = memory(60 * 60 * 3)
        let { clone: ctrl1Clone, write: ctrl1Write, clear: ctrl1Clear } = memory(60 * 60 * 3)
        let { clone: ctrl2Clone, write: ctrl2Write, clear: ctrl2Clear } = memory(60 * 60 * 3)
        let blobs = [] as Blob[]
        ...
        const loop = () => {
            ...
            // let arrow1 = count <= 64 ? 5 : Math.floor(Math.random() * 8.99) + 1
            // let attack1 = count <= 64 ? 0 : Math.floor(Math.random() * 3.99)
            // const nowCtrl1 = [
            ...
            // let arrow2 = count <= 64 ? 5 : Math.floor(Math.random() * 8.99) + 1
            // let attack2 = count <= 64 ? 0 : Math.floor(Math.random() * 3.99)
            // const nowCtrl2 = [
